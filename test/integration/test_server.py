...
class FakeRebootError(BaseException):
    """This is for testing the server. Indicates a handler requested a reboot.
    By inheriting BaseException we ensure that this won't be caught by
